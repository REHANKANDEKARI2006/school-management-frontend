...
export function EventCertificateDialog({ event }: EventCertificateDialogProps) {
  ...
  return (
    <DialogContent className="sm:max-w-4xl p-0">
      ...
      {!showCertificate ? (
        <div className="p-6">
          <h3 className="text-lg font-medium mb-2">Generate Certificate for {event.event_name}</h3>
            ...
            <div className="relative z-10 text-center flex-grow flex flex-col justify-center">
              ...
              <div className="mt-12 flex justify-between items-end px-8">
                <div className="text-left">
                  <p className="font-semibold text-lg">{event.event_date ? new Date(event.event_date).toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' }) : "N/A"}</p>
