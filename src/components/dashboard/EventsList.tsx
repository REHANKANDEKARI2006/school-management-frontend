        ...
        <div className="flex flex-col gap-4">
          {events.map((event, idx) => (
            <motion.div
              ...
              className="group relative pl-4 border-l-4 border-l-blue-500 bg-slate-50/50 hover:bg-white p-4 rounded-xl border border-slate-100/50 hover:border-blue-100 transition-all"
            >
              <div className="flex items-center justify-between mb-1">
                <h3 className="font-bold text-slate-800 text-sm group-hover:text-blue-600 transition-colors leading-tight">{event.title}</h3>
              </div>
