...
export const FeeCollection = ({ stats }: FeeCollectionProps) => {
  return (
    <Card className="border border-slate-100/80 shadow-sm bg-white overflow-hidden rounded-2xl h-full flex flex-col justify-between hover:shadow-md transition-all duration-300 min-h-[320px] sm:min-h-[380px]">
      <div>
        ...
        <CardContent className="p-4 sm:p-6 space-y-3 sm:space-y-4">
          <div className="flex items-center justify-between p-3 sm:p-4 bg-slate-50/50 rounded-xl border border-slate-100 select-none">
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-4 select-none">
            ...
            <div className="p-3 sm:p-4 bg-rose-50/50 rounded-xl border border-rose-100">
      ...
      <div className="p-4 sm:p-6 pt-0 select-none shrink-0">
